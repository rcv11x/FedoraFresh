...
org.gnome.gedit                                         Editor de texto de Gnome
com.github.tchx84.Flatseal                              Flatseal (Administrador de permisos de Flatpak)
...
com.heroicgameslauncher.hgl                             HeroicGamesLauncher (Lanzador de juegos de código abierto de Epic Games, GOG y Amazon Prime Games)
net.lutris.Lutris                                       Lutris - Gestor de juegos multiplataforma
org.prismlauncher.PrismLauncher                         PrismLauncher (Lanzador personalizado para Minecraft)
...
[Desarrollo]="com.visualstudio.code                     VisualStudioCode (Editor de codigo)
com.visualstudio.code-oss                               VisualStudioCode OSS (Editor de codigo)
